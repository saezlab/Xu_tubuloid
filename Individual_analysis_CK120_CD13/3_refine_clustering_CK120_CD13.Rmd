---
title: "CK120 sorted CD13+ cells : Refine cell clustering"
...
We remove one cell populations: endothelial cells. This is a contaminant population since
this sample is sorted CD13+, a well-known marker of PT cells. This cluster is already 
labelled as "Exclude", that we use to remove it here:
