...
```
    ...
    ## Loading ADPKD_PDK1KO 's SeuratObject
    ## Loading ADPKD_PDK2KO's SeuratObject
...
```
    ...
    ## [1] "CK5_organoid"    "CK119_organoid"  "JX1_HC_organoid" "ADPKD_PDK1KO "  
    ## [5] "ADPKD_PDK2KO"    "CK120_CD13"      "CK121_CD24"
...
![](create_color_palette_files/figure-gfm/pal_vis-1.png)<!-- -->
