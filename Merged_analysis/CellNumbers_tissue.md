Number of cells during filtering in tissue
================
...
```
    ...
    ## Reading:CK224_PT25_PKD2-
    ## Reading:CK225_PT8_PKD1-
    ## Reading:ADPKD3
    ## Reading:Control1
    ## Reading:Control2
...
![](CellNumbers_tissue_files/figure-gfm/IntegratedTissue_cell_prop-1.png)<!-- -->
