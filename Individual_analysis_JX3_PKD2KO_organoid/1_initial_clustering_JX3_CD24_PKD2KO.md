PKD2-KO organoid derived from human CD24+ cells: initial clustering
================
...
```
    ...
    ##     TSIX, C4BPA, GPRIN3, SLC3A1, IGFBP3, KLF6, ID4, ZFP36L2, FAM20A, NCOA7 
...
![](1_initial_clustering_JX3_CD24_PKD2KO_files/figure-gfm/clustree-1.png)<!-- -->
