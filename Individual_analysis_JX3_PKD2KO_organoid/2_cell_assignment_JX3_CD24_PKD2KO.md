PKD2-KO organoid derived from human CD24+ cells : cell assignment
================
...
``` r
FeaturePlot(SeuratObject, features=c("percent.mt", "nFeature_RNA"), label=TRUE, label.size=10)
```

![](2_cell_assignment_JX3_CD24_PKD2KO_files/figure-gfm/badQual-1.png)<!-- -->
...
![](2_cell_assignment_JX3_CD24_PKD2KO_files/figure-gfm/AdultOrganoid_mhp-1.png)<!-- -->
...
![](2_cell_assignment_JX3_CD24_PKD2KO_files/figure-gfm/AdultOrganoid_dplot-1.png)<!-- -->
...
![](2_cell_assignment_JX3_CD24_PKD2KO_files/figure-gfm/ClustReport-1.png)<!-- -->
...
![](2_cell_assignment_JX3_CD24_PKD2KO_files/figure-gfm/unnamed-chunk-1-1.png)<!-- -->
