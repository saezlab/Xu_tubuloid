---
title: "CK224 whole tissue biopsy, PKD2- genotype: initial clustering"
...
* We discard cells with low (<200) and high (>4000) number of genes detected to 
avoid bad quality and doublets, repectively.    
* We discard genes not detected across cells.    
In addition, we consider a thresholds of 10% for MT gene expression since this is
single-nucleus RNAseq but ambient RNA from cytoplasm has contaminated the library.
Later we will ignore remaining MT gene expression because this cannot be derived from
the nucleus.
