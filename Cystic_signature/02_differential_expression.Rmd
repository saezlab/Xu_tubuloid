...
```{r UMAP_individualAnnotation, fig.width=8, fig.height=7}
...
```{r UMAP_sub, fig.width=8, fig.height=7}
...
```{r fgsea_GO, fig.width=9, fig.height=5}
...
```{r enricher_GO, fig.width=10, fig.height=5}
# set.seed(1234)
