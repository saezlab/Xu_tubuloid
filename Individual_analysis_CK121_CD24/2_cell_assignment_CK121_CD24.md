CK121 sorted CD24+ cells : cell assignment
================
...
Looking into them, we could identify different cell lineages that are
actually contaminant and not expected in the CD24+ sorted cells: -
...
Cluster 4 | epithelium 43% AKAP12, 11% SLC34a1, 15% SLC22a6, proximal
tubule injured/scattered (STCs) |  
...
Cluster 9 | epithelium 61% cldn1, 54% AKAP12, 61% KLK6, PECs also VCAM1
highest cluster PECs |  
...
![](2_cell_assignment_CK121_CD24_files/figure-gfm/cond_heatmap-1.png)<!-- -->
...
![](2_cell_assignment_CK121_CD24_files/figure-gfm/expr_heatmap-1.png)<!-- -->
...
![](2_cell_assignment_CK121_CD24_files/figure-gfm/unnamed-chunk-1-1.png)<!-- -->
