Control1 whole tissue biopsy, healthy: cell assignment
================
...
![](2_cell_assignment_files/figure-gfm/cellQual-1.png)<!-- -->
...
# Correction by hand
ren_id[names(ren_id)=="4"] <- "EC-PTC"
ren_id[names(ren_id)=="7"] <- "GC-EC"
ren_id[names(ren_id)=="8"] <- "iPT"
ren_id[names(ren_id)=="11"] <- "PEC"
ren_id[names(ren_id)=="14"] <- "T-cell"
# Index them
...
```
    ...
    ##         0         1         2         3         4         5         6 
    ##    "PT_1"   "DCT_1"    "PT_2"     "CNT"  "EC-PTC"     "TAL" "IC-A1_1" 
    ##         7         8         9        10        11        12        13 
    ##   "GC-EC"     "iPT"     "POD" "IC-A1_2"     "PEC"      "MC"   "DCT_2" 
    ##        14 
    ##  "T-cell"
...
![](2_cell_assignment_files/figure-gfm/AdultOrganoid_mhp-1.png)<!-- -->
...
![](2_cell_assignment_files/figure-gfm/AdultOrganoid_dplot-1.png)<!-- -->
...
![](2_cell_assignment_files/figure-gfm/ClustReport-1.png)<!-- -->
