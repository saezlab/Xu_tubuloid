Organoid derived from CD24+ cells using H.Clevers protocol: cell
assignment
================
...
Cluster 0 | TPC : KRT18, VIM |  
Cluster 1 | TPC : ATP6V161 |  
Cluster 2 | DCT-like : DDP4, ANPEP, SLC12A3 |  
Cluster 3 | DCT/PC-like : GATA4, PROM1, high SOX9, LHX1 |  
Cluster 4 | TPC: FXYD3, SLC34A2, CUBN |  
Cluster 5 | Prolif.TPC |  
Cluster 6 | diff.TPC : low KIM, low CD24, low PAX8, low EPCAM |  
Cluster 7 | TPC: CD74, SLC34A2, LGR4 |  
Cluster 8 | Prolif.TPC : KI67, ANXA3, ANPEP |  
Cluster 9 | TAL-like : VCAM1, CLDN10, CLDN14, SLC12A1 |  
cluster 10 | TPC : low PAX8 |  
cluster 11 | PT-like |  
cluster 12 | TPC: DDK3, ANPEP |
...
![](2_cell_assignment_JX1_HC_organoid_files/figure-gfm/cellQual-1.png)<!-- -->

``` r
VlnPlot(SeuratObject, features=c("S.Score", "G2M.Score"))
```

![](2_cell_assignment_JX1_HC_organoid_files/figure-gfm/CellCycle-1.png)<!-- -->

``` r
ren_id <- c("0"="TPC_1:LowCov",
            "1"="TPC_2",
            "2"="TPC_3",
            "3"="DCT-like_1",
            "4"="Prolif.TPC_1",
...
![](2_cell_assignment_JX1_HC_organoid_files/figure-gfm/AdultOrganoid_mhp-1.png)<!-- -->
...
![](2_cell_assignment_JX1_HC_organoid_files/figure-gfm/AdultOrganoid_dplot-1.png)<!-- -->
...
![](2_cell_assignment_JX1_HC_organoid_files/figure-gfm/ClustReport-1.png)<!-- -->
...
![](2_cell_assignment_JX1_HC_organoid_files/figure-gfm/unnamed-chunk-1-1.png)<!-- -->
...
```
    ...
    ## [19] BiocGenerics_0.30.0  ggplot2_3.2.1        Seurat_3.1.0        
    ## [22] nvimcom_0.9-82      
    ## 
